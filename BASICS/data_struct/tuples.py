...
while True:
   ...
   if ChooseLocation == "john pork's house":
      print(f"You have chosen to visit John Pork's House, which is located at the coordinates {johnPorkHouseCoord}.")
      break
   elif ChooseLocation == "the town":
      print(f"You have chosen to visit The Town, which is located at the coordinates {townCoord}.")
      break
   elif ChooseLocation == "the empire state building":
      print(f"You have chosen to visit The Empire State Building, which is located at the coordinates {empireStateBuildingCoord}.")
      break
   elif ChooseLocation == "new york city":
      print(f"You have chosen to visit New York City, which is located at the coordinates {newYorkCityCoord}.")
      break
   elif ChooseLocation == "toronto":
      print(f"You have chosen to visit Toronto, which is located at the coordinates {torontoCoord}.")
      break
   elif ChooseLocation == "paris":
      print(f"You have chosen to visit Paris, which is located at the coordinates {parisCoord}.")
      break
   else:
